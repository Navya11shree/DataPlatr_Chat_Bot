...
// // Define types for the demo data
// interface Demo {
//   id: 'ai-search' | 'ai-conversation' | 'demo-3' | 'demo-4';
//   title: string;
//   icon: JSX.Element;
//   description: string;
// }
...
//               className="w-10 h-10"
//             />
//             <h1 className="text-2xl font-bold text-gray-800">Data Platr Demo Selection</h1>
//           </div>
//         </div>
//       </div>
